/*
This file offers the decode_PNG() function, which reads
& decompresses the RGBA pixel values from a PNG image. 
...
to avoid including "assert.h" and "stdio.h"

All other code is implementation detail.
*/
...
static DecodedImage * decode_PNG(
    uint8_t * compressed_bytes,
    uint32_t compressed_bytes_size)
{
